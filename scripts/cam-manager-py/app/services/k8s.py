                ...
                "spec": {
                    "containers": [{
                        ...
                        "env": [
                            ...
                            {"name": "CLOUD_STORAGE_ENABLED", "value": os.getenv("CLOUD_STORAGE_ENABLED", "false")},
                            {"name": "CLOUD_STORAGE_PROVIDER", "value": os.getenv("CLOUD_STORAGE_PROVIDER", "spaces")},
                            {"name": "CLOUD_STORAGE_ACCESS_KEY", "value": os.getenv("CLOUD_STORAGE_ACCESS_KEY", "")},
                            {"name": "CLOUD_STORAGE_SECRET_KEY", "value": os.getenv("CLOUD_STORAGE_SECRET_KEY", "")},
                            {"name": "CLOUD_STORAGE_BUCKET", "value": os.getenv("CLOUD_STORAGE_BUCKET", "")},
                            {"name": "CLOUD_STORAGE_REGION", "value": os.getenv("CLOUD_STORAGE_REGION", "")},
                            {"name": "CLOUD_STORAGE_ENDPOINT", "value": os.getenv("CLOUD_STORAGE_ENDPOINT", "")},
                            {"name": "CLOUD_DELETE_LOCAL", "value": os.getenv("CLOUD_DELETE_LOCAL", "true")},
                        ],
                        "volumeMounts": [{
                            "name": "recordings",
